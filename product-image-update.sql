...
UPDATE products
SET product_image_url="https://artline.ua/storage/images/products/36211/gallery/348438/1400_gallery_1739272372406359_0.webp"
WHERE subcategory_id=1 and name LIKE '%intel%';

UPDATE products
SET product_image_url="https://www.centurytech.sg/wp-content/uploads/2024/05/2198982-amd-ryzen-ai-pro-processor-product.webp"
WHERE subcategory_id=1 and name LIKE '%amd%';

UPDATE products
SET product_image_url="https://www.intel.com/content/dam/www/central-libraries/us/en/images/2023-01/badge-xeon-workstation-w9.png"
WHERE id=135;

UPDATE products
SET product_image_url="https://cdn.shopify.com/s/files/1/0660/1247/9677/files/MC_Mac_Mini_M2_performance_m2_pro_large_2x_0ddd6b45-d5c1-4294-b37e-0cc94076c001.png"
WHERE id=136;

UPDATE products
SET product_image_url="https://media.ldlc.com/r1600/ld/products/00/05/97/93/LD0005979361.jpg"
WHERE id=138;

-- Subcategory 2

UPDATE products
SET product_image_url="https://img.kwcdn.com/product/fancy/f0a547b3-b413-4046-84df-6145420d9bae.jpg?imageMogr2/auto-orient%7CimageView2/2/w/800/q/70/format/webp"
WHERE subcategory_id=2;

UPDATE products
SET product_image_url="https://dlcdnwebimgs.asus.com/gain/1D932B04-AC21-4448-8EC6-8B157180C53F"
WHERE id=145;

UPDATE products
SET product_image_url="https://nzxt.com/cdn/shop/files/n7-z790-white-uncovered.png?v=1744700012&width=2000"
WHERE id=149;

-- Subcategory 3

UPDATE products
SET product_image_url="https://www.pny.com/productimages/D3266C6F-D466-41A0-B948-B25F00B01415/images/1-PNY-RTX-5070-ARGB-OC-EPIC-X-Triple-Fan-ra.png"
WHERE subcategory_id=3 and name LIKE '%RTX%';

UPDATE products
SET product_image_url="https://static0.xdaimages.com/wordpress/wp-content/uploads/2023/02/amd-radeon-rx-7900-xtx-product-trans.png"
WHERE subcategory_id=3 and name LIKE '%RX%';

UPDATE products
SET product_image_url="https://theitgear.com/wp-content/uploads/2024/05/NVIDIA-GeForce-RTX-4090-24GB-GDDR6X-Founders-Edition-Graphics-Card2.webp"
WHERE id=155;

UPDATE products
SET product_image_url="https://olcha.uz/image/700x700/products/lqV7jYSxTVAY2wcGiGmBe18nRmdymUJoCiZI3Jhg3QKut5QmQpV4eSbnqfmW.jpg"
WHERE id=164;

-- Subcategory 4

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/16007/16007216.png"
WHERE subcategory_id=4;

UPDATE products
SET product_image_url="https://images.teamgroupinc.com/products/memory/u-dimm/ddr5/delta-rgb/black/01.jpg"
WHERE id=169;

-- Subcategory 5

UPDATE products
SET product_image_url="https://cdn3d.iconscout.com/3d/premium/thumb/ssd-3d-icon-png-download-11430910.png"
WHERE subcategory_id=5;

UPDATE products
SET product_image_url="https://www.seagate.com/content/dam/seagate/assets/products/gaming-drive/pc-gaming/firecuda-530r-ssd-heatsink/images/Seagate-FireCuda-530R_530R-Heatsink_Side-by-Side_Lo-Res_640x640.png/_jcr_content/renditions/1-1-large-640x640.png"
WHERE subcategory_id=179;

-- Subcategory 6

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/2507/2507427.png"
WHERE subcategory_id=6;

UPDATE products
SET product_image_url="https://img.overclockers.co.uk/images/CA-06T-SS/742f4ed2d09ea02ed25a9792d7d9a676.jpg"
WHERE id=189;

-- Subcategory 7

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/18505/18505868.png"
WHERE subcategory_id=7;

-- Subcategory 8

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/2703/2703691.png"
WHERE subcategory_id=8;

-- Subcategory 9

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/2933/2933296.png"
WHERE subcategory_id=9;

UPDATE products
SET product_image_url="https://www.asus.com/media/global/products/k8ve5xz25vjthqw9/P_setting_xxx_0_90_end_692.png"
WHERE id=222;

-- Subcategory 10

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/3844/3844261.png"
WHERE subcategory_id=10;

-- Subcategory 11

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/3457/3457608.png"
WHERE subcategory_id=11;

-- Subcategory 12

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/1606/1606161.png"
WHERE subcategory_id=12;

-- Subcategory 13

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/4944/4944038.png"
WHERE subcategory_id=13;

-- Subcategory 14

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/2286/2286861.png"
WHERE subcategory_id=14;

-- Subcategory 15

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/3786/3786658.png"
WHERE subcategory_id=15;

-- Subcategory 16

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/1687/1687471.png"
WHERE subcategory_id=16;

-- Subcategory 17

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/3547/3547786.png"
WHERE subcategory_id=17;

-- Subcategory 18

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/15371/15371475.png"
WHERE subcategory_id=18;

-- Subcategory 19

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/9380/9380200.png"
WHERE subcategory_id=19;

-- Subcategory 20

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/11813/11813903.png"
WHERE subcategory_id=20;

-- Subcategory 21

UPDATE products
SET product_image_url="https://cdn-icons-png.flaticon.com/512/8110/8110634.png"
WHERE subcategory_id=21;
